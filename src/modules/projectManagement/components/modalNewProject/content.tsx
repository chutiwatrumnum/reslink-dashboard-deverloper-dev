...
export const FormNewProject = (
    ...
    console.log('setFormObject', setFormObject);
    ...
    const handleDeleteImage = () => {
        setFormObject({ ...formObject, imageProject: "" });
        setTempImageUrl("");
    ...
    const handleCropSave = (croppedImageUrl: string) => {
        setFormObject({ ...formObject, imageProject: croppedImageUrl });
    ...
    return (
        <>
            ...
            <Form
                ...
                initialValues={{
                    projectType: 'Village',
                    latitude: formObject.lat,
                    longitude: formObject.long,
                    numbeBuilding: formObject.numbeBuilding,
                    floor: formObject.floor,
                    image: formObject.imageProject,
            ...
            >
                ...
                <Row gutter={16}>
                    ...
                    <Col span={12}>
                        ...
                        >
                            <Radio.Group
                                value={formObject.projectType}
                                onChange={(e) => setFormObject({ ...formObject, projectType: e.target.value })}
                            >
                                <Radio value="Condo">Condo</Radio>
                                <Radio checked={true} value="Village">Village</Radio>
                            </Radio.Group>
                        </Form.Item>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    {/* {console.log("formObject.imageProject", formObject.imageProject)} */}
                                    {formObject.imageProject ? (
                    ...
                    {/* Right side - Map and other fields */}
                    <Col span={12}>
                        ...
                        >
                            <Input
                                ...
                                onChange={(e) => setFormObject({ ...formObject, lat: e.target.value })}
                                disabled={true}
                            />
                        </Form.Item>
                        ...
                        >
                            <Input
                                ...
                                value={formObject.long}
                                onChange={(e) => setFormObject({ ...formObject, long: e.target.value })}
                                disabled={true}
                            />
                        </Form.Item>

                        {
                            formObject.projectType === "Condo" && (
                                <>
                                    <Form.Item
                                        label="Number of building"
                                        name="numbeBuilding"
                                        rules={[{ required: true, message: 'Please input number of building!' }]}
                                        className='!mb-4'
                                    >
                                        <Input
                                            className='!rounded-xl'
                                            placeholder="10"
                                            value={formObject.numbeBuilding}
                                            onChange={(e) => {
                                                const value = e.target.value;
                                                // Only allow numbers
                                                if (/^\d*$/.test(value)) {
                                                    setFormObject({ ...formObject, numbeBuilding: value ? parseInt(value) : 0 });
                                                }
                                            }}
                                            onKeyPress={(e) => {
                                    ...
                                    >
                                        <Input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                // Only allow numbers
                                                if (/^\d*$/.test(value)) {
                                                    setFormObject({ ...formObject, floor: value ? parseInt(value) : 0 });
                                                }
                                            }}
                                            onKeyPress={(e) => {
                                                // Prevent non-numeric characters from being typed
